...
#     search_fields = ("title", "uploaded_by__user__username")
...
#     search_fields = ("title", "assigned_by__user__username", "assigned_to__user__username")
...
#     search_fields = ("participant__user__username", "institution__name")
